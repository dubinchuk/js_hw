...
import { ProductsAxiosApiClient } from '../../clients/product.clients.js';
...
import { SignInAxiosApiService } from '../../services/signIn/signIn.service.js';
import allure from '@wdio/allure-reporter';

describe('[API] [Products] Smoke', () => {
  describe('Create', () => {
    const productsApi = new ProductsAxiosApiClient();
    const signInAxiosApiService = new SignInAxiosApiService();
    let token = '';
    let createdProduct: IProductResponse;

    beforeEach(async () => {
      await signInAxiosApiService.signInAsAdminApi();
      token = signInAxiosApiService.getToken();
    });
    ...
    it('Should create product', async () => {
      allure.addStory('Creating product with valid data via API');
